USE BDPERSONAL
DECLARE @lcodigo varchar(10) ='084680'
...
update maestro set codcargo = '0000' where CODIGO = '084680'

select * from T_CargoPresupuestal where 
...
/* UPDATE MAESTRO  SET CODCARGO = '0000', CODNIVEL = '0', HABER = 0, CODHORA = 'V', CODFUNCION = '0000', 
  ...
  SELECT * FROM MAESTRO WHERE DNI = '43055897'
...
UPDATE  MAESTRO  SET   CODCARGO = CASE WHEN (MAESTRO.CODCARGO IS NULL) THEN '0000' ELSE CASE WHEN LEN(MAESTRO.CODCARGO)>4 THEN SUBSTRING(CODCARGO,2,4) ELSE  CODCARGO END END,
                       ...
                       HABER = CASE WHEN (MAESTRO.HABER IS NULL) THEN 0.000 ELSE MAESTRO.HABER END
