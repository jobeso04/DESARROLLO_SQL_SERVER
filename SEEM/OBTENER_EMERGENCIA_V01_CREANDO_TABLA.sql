...
UPDATE PACIENTE SET DOCUMENTO = '99999999' WHERE DOCUMENTO IN ('R.N.', '01', 'NO RECUERDA', 'NO TIENE', 'NO SABE', '0', 'NO REFIERE', 'EN TRAMITE', 'NO SE ACUERDA', 'NO TRAJO', '00000000', 'TRAMITE', 'NO LO TRAE', 'NO REGISTRA',
     '000000000', '000', '.07656544',  ' RUN 23512831-4',  '             NO SABE', ' NO RECUERDA', ' NO SABE', ' NO SE ACUERDA', ' NO TIENE', '.', 'NO SE RECUERDA', 'R.N', 'RECUERDA', 'NO REDUERDA', 'NO RECUEDA', 'NO RECDUERDA', 'NO RECUERDO', 'NO RECFUERDA', 'NO TIENE DNI', 'NOTIENE', '}', 'Ç', 'NO TRAE', 'NOSABE', '0000000',  'NO LO TIENE', '3', 'NO RECUERSA', '07', 'NO HAY SISTEMA', 'NO RECUERA')
