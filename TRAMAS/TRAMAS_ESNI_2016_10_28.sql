...
use SIGSALUD
DECLARE @lcfecha1 datetime = convert(datetime, '2016-10-01', 101)
DECLARE @lcfecha2 datetime = convert(datetime, '2016-10-31', 101)


DECLARE @lperiodo varchar(6) = '102016'
DROP TABLE TRAMA_ESNI_PRE 
DROP TABLE TRAMA_ESNI_FINAL
SELECT * INTO TRAMA_ESNI_PRE  
 FROM HIS WHERE PERIODO = @lperiodo  AND CODIGO1 IN ('90713', '90712', '90675', '90676', '90717', '90657', '90701', '90744', '90669', '90681', '90649', '90707', '90708', '90585', '90723')
UNION ALL
SELECT * FROM HIS WHERE PERIODO = @lperiodo  AND CODIGO2 IN ('90713', '90712', '90675', '90676', '90717', '90657', '90701', '90744', '90669', '90681', '90649', '90707', '90708', '90585', '90723')
UNION ALL
SELECT * FROM HIS WHERE PERIODO = @lperiodo  AND CODIGO3 IN ('90713', '90712', '90675', '90676', '90717', '90657', '90701', '90744', '90669', '90681', '90649', '90707', '90708', '90585', '90723')
UNION ALL
SELECT * FROM HIS WHERE PERIODO = @lperiodo  AND CODIGO4 IN ('90713', '90712', '90675', '90676', '90717', '90657', '90701', '90744', '90669', '90681', '90649', '90707', '90708', '90585', '90723')
UNION ALL
SELECT * FROM HIS WHERE PERIODO = @lperiodo  AND CODIGO5 IN ('90713', '90712', '90675', '90676', '90717', '90657', '90701', '90744', '90669', '90681', '90649', '90707', '90708', '90585', '90723')
UNION ALL
SELECT * FROM HIS WHERE PERIODO = @lperiodo  AND CODIGO6 IN ('90713', '90712', '90675', '90676', '90717', '90657', '90701', '90744', '90669', '90681', '90649', '90707', '90708', '90585', '90723')
...
SELECT  DISTINCT '005947' AS RENIPRESS,   MT AS TURNO, A.ANIO + RIGHT('00' + Ltrim(Rtrim(A.MES)),2) + RIGHT('00' + Ltrim(Rtrim(A.DIA)),2) as FECHA_ATE, A.ESTABLEC AS COND_ESTABL, A.ETNIA, A.FICHAFAM AS PACHIS,
  A.FINANCIA, case TIPO_DOC when 'A' then '0' when 'D' then '1'  when 'PN' then '1' when 'CI' then '1' WHEN '' THEN '0' WHEN 'CE' THEN '2' WHEN '0' THEN '0'  else '0' end AS TIPDOC, A.DNI AS DOCID,
   SUBSTRING(CONVERT(VARCHAR(10), B.FECHA_NACIMIENTO, 105), 1, 2) + '/' + SUBSTRING(CONVERT(VARCHAR(10), B.FECHA_NACIMIENTO, 105), 4, 2) + '/'  +  SUBSTRING(CONVERT(VARCHAR(10), B.FECHA_NACIMIENTO, 105), 7, 4)   AS FECNAC,
      CASE A.SEXO WHEN 'M' THEN '1' ELSE '2' END AS SEXO, B.NOMBRES, B.PATERNO AS APPATERNO, B.MATERNO AS APMATERNO, B.DIRECCION,
     '' PESO, '' TALLA, CASE WHEN A.LABCONF2 = 'G' THEN 'S' ELSE 'NA'  END AS  GESTANTE,    A.PROCEDE AS PROCEDENCIA, A.COD_SERVSA AS  UPS, A.SERVICIO AS COND_SERV, D.semprofesion AS TIPO_PS,
      ...
      CASE WHEN SUBSTRING(A.LABCONF6,1,1) IN ('1','2', '3', '4', '5', '6', '7', '8', '9')   THEN A.LABCONF6 ELSE '' END AS DOSIS6, A.CODIGO6 AS VACUNA6, '' AS CIE6,
        CASE WHEN SUBSTRING(A.LABCONF6,1,2)  = 'ST' THEN  'ST' ELSE '' END AS POBRIESGO6 INTO TRAMA_ESNI_FINAL
...
UPDATE TRAMA_ESNI_FINAL SET VACUNA2 = '' WHERE VACUNA2 IS NULL
UPDATE TRAMA_ESNI_FINAL SET VACUNA3 = '' WHERE VACUNA3 IS NULL
UPDATE TRAMA_ESNI_FINAL SET VACUNA4 = '' WHERE VACUNA4 IS NULL
UPDATE TRAMA_ESNI_FINAL SET VACUNA5 = '' WHERE VACUNA5 IS NULL
UPDATE TRAMA_ESNI_FINAL SET VACUNA6 = '' WHERE VACUNA6 IS NULL
SELECT * FROM TRAMA_ESNI_FINAL
