use SIGSALUD
/* EN ESTADO 2 */
DECLARE @lid2 VARCHAR(13) = '18003514'
select * from [SIGSALUD].[dbo].[EMERGENCIA] where EMERGENCIA_ID = @lid2
select * from [SIGSALUD].[dbo].[EMERGENCIA_DET_WEB] where EMERGENCIA_ID = @lid2
...
DECLARE @lid2 VARCHAR(13) = '18003514'
DELETE FROM [SIGSALUD].[dbo].[EMERGENCIA] where EMERGENCIA_ID = @lid2
DELETE FROM [SIGSALUD].[dbo].[EMERGENCIA_DET_WEB] where EMERGENCIA_ID = @lid2
DELETE FROM [SIGSALUD].[dbo].[EmergenciaDetalleProcedimiento] where IdEmergenciaDetalle = @lid2
DELETE FROM [SIGSALUD].[dbo].[ORDEN_EXAMEN_WEB] where ID_ATENCION = @lid2
