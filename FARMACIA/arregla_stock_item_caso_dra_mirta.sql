...
select * from ITEM where ITEM = '170608'
select * from KARDEX  where ITEM = '170608' and almacen = 'F' order by FECHA desc
/* ejecutar en el servidor */
update KARDEX set  ALMACEN = 'F', STOCK=364, SALDO = 363 where OPERACION = '16258015'
