...
declare @lcedad2r2 int = 4
	...
	select 'EDAS ENTRE 1 Y 4 AÑOS ' AS TITULO, (case when b.distrito = 'LURIGANCHO' THEN 'CHOSICA' ELSE b.distrito  END) as cdistrito, upper(c.nombre) as clocalidad, count(a.paciente) as menor1 
