...
delete FROM  [SIGSALUD].[dbo].[ROLACTIVIDAD] WHERE PERIODO = @lcperiodo AND  CONSULTORIO = @lcconsultorio
delete FROM  [SIGSALUD].[dbo].[ROLACTIVIDADC] WHERE PERIODO = @lcperiodo AND  SERVICIO = @lc_servicio
