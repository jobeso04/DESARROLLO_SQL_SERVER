 ...
 SELECT  CONVERT(VARCHAR(10), a.FECHA_REGISTRO,103) AS FECHA_DE_PAGO, CONVERT(VARCHAR(5), CONVERT(TIME(7), a.FECHA_REGISTRO)) AS HORA_DE_PAGO, B.HISTORIA,  A.NOMBRE, A.CONSULTORIO AS UPS, ITEM_NOMBRE AS CONCEPTO_DE_PAGO, TOTAL AS TOTAL_BOLETA 
 from V_Boleta_Grupo A  LEFT JOIN PACIENTE B ON A.PACIENTE = B.PACIENTE
