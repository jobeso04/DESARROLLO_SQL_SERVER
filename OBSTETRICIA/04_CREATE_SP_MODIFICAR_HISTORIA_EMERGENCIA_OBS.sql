...
/****** Object:  StoredProcedure [dbo].[SP_MODIFICAR_HISTORIA_EMERGENCIA_OBS]    Script Date: 06/14/2016 12:04:04 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_MODIFICAR_HISTORIA_EMERGENCIA_OBS]
...
AS BEGIN
	...
	UPDATE EMERGENCIA SET PRIORIDAD=@prioridad,HORAINICIOATENCION=@horainicioatencion,EXAMEN_FISICO=@examen_fisico,SINTOMAS=@sintomas,
