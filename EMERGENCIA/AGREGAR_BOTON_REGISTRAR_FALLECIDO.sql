...
INSERT INTO [SIGSALUD].[dbo].[PLANTILLA_BOTONES]([ID_PL_BOTON], [NOMBRE],[ICONO],[ESTADO],[ID_HTML],[ID_PL_SUBMENU],[ID_PL_MENU],[ID_PL_M])
     VALUES ('16000001', 'Registrar Fallecidos', '<i class="fa fa-plus" aria-hidden="true"></i>', 0, 'registrar-fallecidos',  '15000004', '15000004', '15000002')
update ACCESO_BOTONES set ESTADO = 1 where DNI in (select dni from USUARIO_WEB where cargo in ('ENFERMERO', 'TECNICO')) and substring(ID_BOTON,9,8) = '16000001'     
...
DECLARE @lidboton varchar(20) = @ldni + '16000001'
