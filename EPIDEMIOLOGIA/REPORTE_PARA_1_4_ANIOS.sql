...
DECLARE @lcfechafin datetime = convert(datetime, '2015-10-17', 101)
    ...
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX1 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX1 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX2 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX2 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
      UNION ALL
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX3 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX3 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX4 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX4 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
     UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX5 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX6 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX7 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX8 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX9 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,3) between @ledad and @ledad1
    UNION ALL
