...
select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX1 as CIEXTOTAL
 from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX1 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
 UNION ALL
...
select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX2 as CIEXTOTAL
 from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX2 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
 UNION ALL
...
select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX3 as CIEXTOTAL
 from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX3 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
UNION ALL
...
select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX4 as CIEXTOTAL
 from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX4 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
UNION ALL
...
from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX5 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
...
from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX6 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
UNION ALL
...
from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX7 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
UNION ALL
...
from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX8 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
UNION ALL
...
from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX9 IN (@lciex1, @lciex2, @lciex3) and SUBSTRING(edad,1,3) BETWEEN @ledad AND @ledad2
UNION ALL
...
select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
  ...
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX1 IN (@lciex1, @lciex2, @lciex3) and TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX2 AS CIEXTOTAL from HOSPITALIZACION 
    where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX2 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX3 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX3 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX4 AS CIEXTOTAL from HOSPITALIZACION 
    where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX4 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX5 AS CIEXTOTAL from HOSPITALIZACION 
     where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX5 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
  UNION ALL    
  
select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX6 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX6 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX8 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX8 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
    
UNION ALL
select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX9 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX9 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4

UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX10 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX10 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
  
UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX11 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX11 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4

 UNION ALL

select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX12 AS CIEXTOTAL from HOSPITALIZACION 
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX12 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
 UNION ALL
...
select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
  ...
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX14 IN (@lciex1, @lciex2, @lciex3)    AND TIPOEDAD = @ltipoedad_anios AND EDAD BETWEEN 1 AND 4
