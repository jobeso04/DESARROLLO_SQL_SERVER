...
insert into  @lctablenoti
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
  ...
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX2 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX3 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX3 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX4 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX4 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX5 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX5 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX6 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX6 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX8 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX8 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX9 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX9 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX10 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX10 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX11 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX11 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)

UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX12 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX12 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX13 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX13 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
UNION ALL
 select 'HOSPITALIZACION' AS EMERGENCIA_ID, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
   DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX14 AS CIEXTOTAL from  [SIGSALUD].[dbo].[HOSPITALIZACION]
  where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX14 IN (SELECT DIAG FROM @lcietabla) and TipoEdad IN (@ltipoedad_mes, @ltipoedad_dias)
...
/*
 select emergencia_id as SERVICIO, convert(varchar(10), a.fecha, 101) as Fecha, convert(varchar(10), hora) hora, a.nombres, a.paciente, d.historia, a.fecha_nacimiento, a.edad, a.sexo, a.direccion, a.distrito, 
