...
/****** Object:  StoredProcedure [dbo].[SP_RAYOSX_PLACAS2]    Script Date: 05/03/2017 16:40:56 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_RAYOSX_PLACAS2](
@inicio VARCHAR(10),
@fin VARCHAR(10)
) AS BEGIN
	...
	ISNULL(SUM(B14_14+M14_14),0) AS B14_14,ISNULL(SUM(B14_17+M14_17),0) AS B14_17, ISNULL(SUM(B8_10+M8_10),0) AS B8_10, ISNULL(SUM(B10_12+M10_12),0) AS B10_12 FROM RAYOSX WHERE FECHA BETWEEN @inicio AND @fin
