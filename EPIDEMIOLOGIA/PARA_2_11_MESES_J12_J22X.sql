...
DECLARE @lcfechafin datetime = convert(datetime, '2015-10-17', 101)
    ...
    declare @ledad1 varchar(6) = '000a11'
    ...
    DECLARE @ledadirasfin varchar(2) = '11'    
    ...
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX1 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX1 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX2 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX2 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
      UNION ALL
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX3 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX3 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    select EMERGENCIA_ID, fecha, HORA, NOMBRES, PACIENTE, FECHA_NACIMIENTO, EDAD, SEXO, DIRECCION, DISTRITO, LOCALIDAD, CIEX4 as CIEXTOTAL
     from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX4 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
     UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX5 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX6 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX7 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX8 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    ...
    from EMERGENCIA where fecha between @lcfechainicio and @lcfechafin  and CIEX9 BETWEEN @lciex1 AND @lciex2 and SUBSTRING(edad,1,6) between @ledad and @ledad1
    UNION ALL
    ...
    SELECT ID_PACIENTE AS EMERGENCIA_ID, FECHA, HORAI_ATENCION AS  HORA, PACIENTE AS  NOMBRES, FICHAFAM AS  PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO, 
      ...
      WHERE FECHA BETWEEN @lcfechainicio AND @lcfechafin AND CODIGO1 BETWEEN @lciex1 AND @lciex2 and DIAGNOST1 = @ltipodiagnostico
         AND TIPOEDAD = @ltipoedad_mes AND EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    SELECT ID_PACIENTE AS EMERGENCIA_ID, FECHA, HORAI_ATENCION AS  HORA, PACIENTE AS  NOMBRES, FICHAFAM AS  PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO, 
    ...
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
     ...
     where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX1 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX2 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX2 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX3 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX3 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX4 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX4 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX5 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX5 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX6 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX6 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX8 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX8 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX9 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX9 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX10 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX10 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX11 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX11 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX12 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX12 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
    UNION ALL
    select HOSPITALIZACION_ID AS ID_EMERGENCIA, FECHA1 AS FECHA, HORA1 AS HORA, NOMBRES  = '', PACIENTE, FECHA_NACIMIENTO = '', CONVERT(VARCHAR(4), EDAD) AS EDAD, SEXO = '',
       DIRECCION = '', DISTRITO = '', LOCALIDAD = '', DX13 AS CIEXTOTAL from HOSPITALIZACION 
         where FECHA1 BETWEEN @lcfechainicio AND @lcfechafin and DX13 BETWEEN @lciex1 AND @lciex2 and TipoEdad = @ltipoedad_mes and EDAD between @ledadirasinicio  and  @ledadirasfin 
