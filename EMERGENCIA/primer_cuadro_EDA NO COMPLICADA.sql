/* EDA NO COMPLICADA*/
 ...
 declare @lcfecha2 datetime = convert(datetime, '2017-05-31', 101)
  ...
  declare @lcfecha2 datetime = convert(datetime, ?lcfecha2, 101) */
   declare @lc_lista_de_ciex  table (id_ciex varchar(20)); insert @lc_lista_de_ciex(id_ciex)  values('A010'),
   ('A010'), ('A011'), ('A012'), ('A013'), ('A014'), ('A020'), ('A05'), ('A078'), ('A080'), ('A082'), ('A083'),
   ('A084'), ('A050'),('A051'),('A052'),('A053'),('A054'),('A058'),('A059')
