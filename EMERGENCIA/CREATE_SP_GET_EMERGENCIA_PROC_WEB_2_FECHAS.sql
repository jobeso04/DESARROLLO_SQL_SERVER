...
/****** Object:  StoredProcedure [dbo].[SP_GET_EMERGENCIA_PROC_WEB_8_2_FECHAS]    Script Date: 02/08/2017 15:12:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_GET_EMERGENCIA_PROC_WEB_8_2_FECHAS]
@p_fecha VARCHAR(10),
@p_fecha2 VARCHAR(10),
@p_turno VARCHAR(1)
AS BEGIN
