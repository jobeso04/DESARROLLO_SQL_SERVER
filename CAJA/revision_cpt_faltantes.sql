...
SELECT  distinct CODCPT, NOMBRE, CLASIFICADOR, agregar_cpt  FROM ITEM WHERE agregar_cpt = 'A' and SUBSTRING(item,1,1) = '6'
SELECT  DISTINCT CODCPT, NOMBRE, CLASIFICADOR, agregar_cpt  FROM ITEM WHERE agregar_cpt = 'N' and SUBSTRING(item,1,1) = '6'
...
select CLASIFICADOR  from dbo.TARIFARIO_TOTAL group by CLASIFICADOR
select * from CLASIFICADOR where CLASIFICADOR in ('1.3.1.6.12', '1.3.2.4.1.99', '1.3.2.4.14', '1.3.2.4.16', '1.3.3.4.17', '1.3.3.4.1.99', '1.3.3.4.13',
'1.3.3.4.16', '1.3.3.4.21', '9.9.9.9.99')
