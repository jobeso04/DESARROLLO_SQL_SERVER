...
/****** Object:  StoredProcedure [dbo].[SP_GUARDAR_ANTECEDENTES_OBSTETRICIA]    Script Date: 12/06/2016 10:08:36 p.m. ******/
SET ANSI_NULLS ON
GO
...
AS BEGIN
	...
	UPDATE EMERGENCIA SET GPOBS=@gpobs, FUROBS=@furobs, FPPOBS=@fppobs, EGUMOBS=@egumobs, EGECOOBS=@egecoobs, USUARIO_ANT_OBSTETRICIA=@medico,
		QUIEN_ATIENDE=@medico, MEDICO = @medico, MEDICO1 = @medico, ESTADO=@estado, USUARIO_FN_VITALES = @medico WHERE EMERGENCIA_ID=@emergencia_id;
