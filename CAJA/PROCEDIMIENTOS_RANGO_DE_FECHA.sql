...
declare @lfechainicio datetime = convert(datetime, '2015-08-01',101) +  CAST('07:30:00' AS DATETIME)
declare @lfechafin datetime = convert(datetime, '2015-08-31',101) + CAST('19:30:00' AS DATETIME)
