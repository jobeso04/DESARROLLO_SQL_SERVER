...
FROM         dbo.EMERGENCIA AS EM LEFT OUTER JOIN
                      ...
                      WHERE EM.EMERGENCIA_ID = '16037438'
                      


DECLARE @lidemergencia varchar(13) =  '16037438' /* '16037314'   */
/* USUARIO QUE REGISTRO FUNCIONES VITALES )POR LO GENERAL LA ENFERMERA O EL TECNICO) EXISTE EN LA TABLA MEDICOS - RELACIONADO POR CODIGO DEL MEDICO 
   COMPARA LA TABLA DE EMERGENCIA Y LA TABLA MEDICO */
...
/* VERIFICA EL NOMBRE DEL ENEFRMERO QUE DIO DE ALTA O CERRO LA HISTORIA TABLA MEDICO Y EMERGENCIA */
select MEDICO AS usuario_alta_enf from medico where medico  = (select usuario_alta_enf from EMERGENCIA  where EMERGENCIA_ID = @lidemergencia)
...
use SIGSALUD
declare @lidemergencia varchar(13) = '16037438'
