...
/****** Object:  StoredProcedure [dbo].[SP_BOTONES_USUARIO_WEB_OBS]    Script Date: 04/27/2016 11:07:33 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_BOTONES_USUARIO_WEB_OBS]
/* @dni char(8),
@modulo varchar(30),
@menu varchar(30),
@submenu varchar(30) */
AS BEGIN
	...
	SELECT     uw.DNI, uw.NOMBRES, am.ID_AM, am.NOMBRE AS MODULO, am.ESTADO AS ESTADO_MODULO, amenu.ID_MENU, amenu.NOMBRE AS MENU, 
         ...
         FROM         dbo.USUARIO_WEB AS uw INNER JOIN
                      ...
                      dbo.ACCESO_BOTONES AS abotones ON asubmenu.ID_SUBMENU = abotones.ID_SUBMENU WHERE am.id_am ='4159563716000002' AND asubmenu.ID_SUBMENU = '4159563716000013';
