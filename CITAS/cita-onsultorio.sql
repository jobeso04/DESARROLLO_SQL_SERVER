...
select * from CITA where CONSULTORIO =


select * from CITA where CONSULTORIO = '5011' and  FECHA >= CONVERT(DATETIME, '2017-07-01', 101) 

select medico from CITA where CONSULTORIO = '5011' and  FECHA >= CONVERT(DATETIME, '2017-07-01', 101)  group by MEDICO 



select * from CITA where CONSULTORIO = '5011' and  FECHA = CONVERT(DATETIME, '2017-07-04', 101)  and MEDICO = 'MTA'

UPDATE CITA SET CONSULTORIO = '5012' where CONSULTORIO = '5011' and  FECHA >= CONVERT(DATETIME, '2017-07-01', 101)  and MEDICO = 'IBL'
...
select COUNT(*) from CITA where FECHA between CONVERT(DATETIME, '2017-07-05', 101)  and CONVERT(DATETIME, '2017-07-05', 101)  and  ESTADO IN ('3', '4', '5')
AND CONSULTORIO IN (
SELECT CONSULTORIO FROM CONSULTORIO WHERE CONSULTORIO LIKE '10%' AND TIPO = 'C'
UNION ALL
SELECT CONSULTORIO FROM CONSULTORIO WHERE CONSULTORIO LIKE '20%' AND TIPO = 'C'
