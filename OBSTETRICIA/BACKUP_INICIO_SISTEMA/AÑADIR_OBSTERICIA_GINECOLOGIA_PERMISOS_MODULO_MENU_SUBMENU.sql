...
use SIGSALUD
select * from dbo.PLANTILLA_MODULO 
select * from dbo.PLANTILLA_MENU 
select * from dbo.PLANTILLA_SUBMENU   
select * from dbo.PLANTILLA_BOTONES   
...
INSERT INTO [SIGSALUD].[dbo].[PLANTILLA_BOTONES](ID_PL_BOTON, NOMBRE, ICONO, ESTADO, ID_HTML, ID_PL_SUBMENU, ID_PL_MENU, ID_PL_M)
     VALUES ('16000027', 'Registrar Antecedentes Obstetricia', '<i class="fa fa-user-md"></i>', '1', 'registrar-antecedente-obstetricia', '16000013', '16000007', '16000002')
INSERT INTO [SIGSALUD].[dbo].[PLANTILLA_BOTONES](ID_PL_BOTON, NOMBRE, ICONO, ESTADO, ID_HTML, ID_PL_SUBMENU, ID_PL_MENU, ID_PL_M)
     VALUES ('16000028', 'Registrar Examen Fisico', '<i class="fa fa-female"></i>', '1', 'registrar-examen-fisico', '16000013', '16000007', '16000002')
INSERT INTO [SIGSALUD].[dbo].[PLANTILLA_BOTONES](ID_PL_BOTON, NOMBRE, ICONO, ESTADO, ID_HTML, ID_PL_SUBMENU, ID_PL_MENU, ID_PL_M)
     VALUES ('16000029', 'Registrar Examen Obstetrico', '<i class="fa fa-pencil-square-o"></i>', '1', 'registrar-examen-obstetrico', '16000013', '16000007', '16000002')
...
delete from dbo.ACCESO_MODULO  where ID_AM = '4159563715000002' 
...
INSERT INTO [SIGSALUD].[dbo].[ACCESO_MENU] ([ID_MENU], [NOMBRE], [ICONO],[URL],[ORDEN],[ESTADO],[ID_AM],[DNI])
     VALUES ('4159563716000006', 'Inicio', '<i class="menu-icon fa fa-home"></i>', 'inicio', '1', '1', '4159563716000002', @luserobs )   
INSERT INTO [SIGSALUD].[dbo].[ACCESO_MENU] ([ID_MENU], [NOMBRE], [ICONO],[URL],[ORDEN],[ESTADO],[ID_AM],[DNI])
     VALUES ('4159563716000007', 'Area de Trabajo', '<i class="menu-icon fa fa-laptop"></i>', 'area_trabajo', '2', '1', '4159563716000002', @luserobs)
INSERT INTO [SIGSALUD].[dbo].[ACCESO_SUBMENU] ([ID_SUBMENU], [NOMBRE], [ICONO], [URL], [ORDEN], [ESTADO], [ID_MENU], [ID_AM], [DNI])
     VALUES ('4159563716000013', 'Principal', '', 'area_trabajo/principal', '1', '1', '4159563716000007', '4159563716000002', @luserobs )
INSERT INTO [SIGSALUD].[dbo].[ACCESO_BOTONES]([ID_BOTON], [NOMBRE], [ICONO],[ESTADO],[ID_SUBMENU],[ID_MENU],[ID_AM],[DNI],[ID_HTML])
     VALUES ('4159563716000027', 'Registrar Antecedentes Obstetricia', '<i class="fa fa-user-md"></i>', '1', '4159563716000013', '4159563716000007', '4159563716000002', @luserobs, 'registrar-antecedente-obstetricia')
INSERT INTO [SIGSALUD].[dbo].[ACCESO_BOTONES]([ID_BOTON], [NOMBRE], [ICONO],[ESTADO],[ID_SUBMENU],[ID_MENU],[ID_AM],[DNI],[ID_HTML])
     VALUES ('4159563716000028', 'Registrar Examen Fisico', '<i class="fa fa-female"></i><i class="fa fa-female"></i>', '1', '4159563716000013', '4159563716000007', '4159563716000002', @luserobs, 'registrar-examen-fisico')



INSERT INTO [SIGSALUD].[dbo].[ACCESO_BOTONES]([ID_BOTON], [NOMBRE], [ICONO],[ESTADO],[ID_SUBMENU],[ID_MENU],[ID_AM],[DNI],[ID_HTML])
     VALUES ('4159563716000029', 'Registrar Examen Obstetrico', '<i class="fa fa-pencil-square-o"></i>', '1', '4159563716000013', '4159563716000007', '4159563716000002', @luserobs, 'registrar-examen-obstetrico')
