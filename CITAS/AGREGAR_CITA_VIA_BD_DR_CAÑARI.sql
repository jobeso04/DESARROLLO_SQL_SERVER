...
SELECT * FROM CITA WHERE MEDICO = 'CMP' AND FECHA = CONVERT(DATETIME, '2017-05-17', 101) AND TURNO_CONSULTA = 'T' ORDER BY CITA_ID ASC

SELECT * FROM CITA WHERE MEDICO = 'CMP' AND FECHA = CONVERT(DATETIME, '2017-05-24', 101) AND TURNO_CONSULTA = 'T'
